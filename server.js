...
return (
Number(l.job_amount || 0) -
Number(l.lead_cost || 0)
);
...
<span class="pill ${l.clean_status}">
${l.clean_status.toUpperCase()}
</span>
...
<p>
<b>Service:</b>
${safe(l.service || "Service Call")}
</p>

<p>
<b>Provider:</b>
${safe(l.provider_assigned || "Not Assigned")}
</p>
